...
CREATE TABLE comunidades (
    ...
    costoPaquete DECIMAL(10, 2) DEFAULT 100.00,
    notas VARCHAR(100),
    createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE efectivoPedidos (
    ...
    billetes500 INT DEFAULT 0,
    billetes200 INT DEFAULT 0,
    billetes100 INT DEFAULT 0,
    billetes50 INT DEFAULT 0,
    billetes20 INT DEFAULT 0,
    
    -- Monedas
    monedas20 INT DEFAULT 0,
    monedas10 INT DEFAULT 0,
    ...
    observaciones TEXT,
    tipoRegistro ENUM('entrega', 'correccion', 'devolucion') DEFAULT 'entrega',
