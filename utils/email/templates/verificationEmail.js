const generateVerificationTemplate = (user) =>  {
    ...
    <table class="main contenttable" align="center" style="font-weight: normal;border-collapse: collapse;border: 0;margin-left: auto;margin-right: auto;padding: 0;font-family: Arial, sans-serif;color: #555559;background-color: white;font-size: 16px;line-height: 26px;width: 600px;">
        ...
        <td class="border" style="border-collapse: collapse;border: 1px solid #eeeff0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;">
            ...
            <tr>
                ...
                <a href="https://bamxzamora.org"><img class="top-image" src="https://bamxzamora.org/assets/images/zamora.webp" style="width: 100px; margin:20px auto; display: block;" alt="BAMX Zamora logo"></a>
                </td>
            </tr>
            ...
            <tr>
                ...
                <table style="width: 100%;">
                    ...
                    <td style="text-align: center; padding-bottom: 15px;">
                        <h1 style="font-size: 28px; margin: 0; color: #0a8e3d;">Tu cuenta ha sido verificada</h1>
                    </td>
                    </tr>
                    <tr>
                    <td style="padding: 10px 0;">
                        <p style="margin: 0;">Hola ${user.username},</p>
                        <p style="margin: 15px 0;">¡Tu cuenta ha sido aprobada por los administradores!</p>
                        <p style="margin: 0;">Ya puedes iniciar sesión en la plataforma.</p>
                    </td>
                    </tr>
                    <tr>
                    <td style="padding: 25px 0; text-align: center;">
                        <a href="https://pedidos.bamxzamora.org/login" 
...
module.exports = { generateVerificationTemplate };